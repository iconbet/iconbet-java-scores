...
public class Snapshot {
    ...
    public final BranchDB<Address, BranchDB<Integer, DictDB<String, Object>>> _stake_snapshots = Context.newBranchDB(_STAKE_SNAPSHOTS, Integer.class);
    ...
    public final BranchDB<Integer, DictDB<String, Object>> _total_staked_snapshot = Context.newBranchDB(_TOTAL_STAKED_SNAPSHOT, Integer.class);
